					...
					<div styleName="contenedolsito">
						<div styleName="cloud-top-container">
							<img
								src={cloud2}
								alt="cloud2-top"
								styleName="cloud2-top"
							></img>
							<img
								src={cloud1}
								alt="cloud-top"
								styleName="cloud1-top"
							></img>
						</div>
						<div styleName="layer">
							<div styleName="en-layer">
								...
								<h5 styleName="firstRowText">
									{lang['FirstRowText']}
								</h5>
								<h5 styleName="secondRowText">
									{lang['SecondRowText']}
								</h5>
								<div styleName="box">
