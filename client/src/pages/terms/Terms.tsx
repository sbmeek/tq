...
export default function Terms() {
	return (
		<div styleName="container">
			...
			<p>
				El presente establece los términos en que SB-Meek usa y protege la
				información que es proporcionada por sus usuarios al momento de utilizar
				su sitio web. Esta compañía está comprometida con la seguridad de los
				...
				hacemos asegurando que sólo se empleará de acuerdo con los términos de
				este documento. Sin embargo esta Política de Privacidad puede cambiar
			...
			<p>
				...
				nombre, información de contacto como su dirección de correo electrónico
			...
			<p>
				SB-Meek está altamente comprometido para cumplir con el compromiso de
			...
			<p>
				...
				de su interés. Una vez que usted de click en estos enlaces y abandone
			...
			<p>
				SB-Meek se reserva el derecho de cambiar los términos de la presente
			...
			<p>
				Este sitio web es operado por Sb-Meek. En todo el sitio, los términos
				“nosotros”, “nos” y “nuestro” se refieren a Sb-Meek. Sb-Meek ofrece este
				...
				aceptación de todos los términos, condiciones, políticas y
				notificaciones aquí establecidos.
			</p>

			<p>
				Al visitar nuestro sitio y/o utilizar algo de nosotros, participas en
				...
				incluyendo sin limitación a usuarios que sean navegadores.
			</p>
			...
			<p>
				...
				tambien estarán sujetas a los Términos de Servicio. Puedes revisar la
				...
				cambios. Tu uso contínuo o el acceso al sitio web después de la
			...
			<p>
				...
				dependencia em el materia de este sitio es bajo su propio riesgo.
			</p>

			<p>
				Este sitio puede contener cierta información histórica. La información
				histórica, no es necesriamente actual y es provista únicamente para tu
			...
			<p>
				...
				nuevas herramientas y recursos). Estas nuevas caraterísticas y/o
			...
			<p>
				...
				puede incluír material de terceras partes.
			</p>
			...
			<p>
				...
				transacción. Quejas, reclamos, inquietudes o pregutas con respecto a
			...
			<p>
				...
				distribuír, traducir o utilizar por cualquier medio comentarios que nos
			...
			<p>
				...
				manera, afectar el funcionamiento del Srvicio o de cualquier sitio web
			...
			<p>
				...
				propósito ilegal; (b) para pedirle a otros que realicen o partiicpen en
				...
				de género, orientación sexual, religión, tnia, raza, edad, nacionalidad
			...
			<p>
				...
				incluídas todas las garantías o condiciones implícitas de
				comercialización, calidad comercializable, la aptitud para un propósito
				particular, durabilidad, título y no infracción.
			</p>

			<p>
				En ningún caso Sb-Meek, nuestros directores, funcionarios, empleados,
				afiliados, agentes, contratistas, internos, proveedores, prestadores de
				servicios o licenciantes serán responsables por cualquier daño, pérdida,
				reclamo, o daños directos, indirectos, incidentales, punitivos,
				especiales o consecuentes de cualquier tipo, incluyendo, sin limitación,
				pérdida de beneficios, pérdida de igresos, pérdida de ahorros, pérdida
				de datos, costos de reemplazo, o cualquier daño similar, ya sea basado
				en contrato, agravio (incluyendo negligencia), responsabilidad estricta
				o de otra manera, como consecuencia del uso de cualquiera de los
				servicios o productos adquiridos mediante el servicio, o por cualquier
				otro reclamo relacionado de alguna manera con el uso del servicio o
				cualquier producto, incluyendo pero no limitado, a cualquier error u
				omisión en cualquier contenido, o cualquier pérdida o daño de cualquier
				tipo incurridos como resultados de la utilización del servicio o
				cualquier contenido (o producto) publicado, transmitido, o que se pongan
				a disposición a través del servicio, incluso si se avisa de su
			...
			<p>
				...
				Servicio, tambien podemos terminar este acuerdo en cualquier momento sin
				previo aviso, y seguirás siendo responsable de todos los montos
				adeudados hasta incluída la fecha de terminación; y/o en consecuencia
				podemos negarte el acceso a nuestros servicios (o cualquier parte del
				mismo).
			</p>
			...
			<p>
				...
				de estas Condiciones de Servicio no constituirá una renucia a tal
